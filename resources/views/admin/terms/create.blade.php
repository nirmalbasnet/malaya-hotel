            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-5">
                            <h6 class="card-title m-t-40"><i class="m-r-5 font-18 mdi mdi-bomb"></i>Terms & Conditions</h6>
                        </div>
                        <form action="{{isset($terms) ? url('admin/terms-and-conditions/'.$terms->id.'/update') : url('admin/terms-and-conditions/submit')}}" enctype="multipart/form-data" method="post"
                              id="addNewMemberForm">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label class="col-md-12"></label>
                                <div class="col-md-12">
                                    <textarea name="description" id="description" class="form-control">{{old('description', isset($terms) ? $terms->description : '')}}</textarea>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-success">{{isset($terms) ? 'Update' : 'Submit'}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
