                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{asset('admin/clients-testimony')}}">Clients Testimony</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-5">
                                <h6 class="card-title m-t-40"><i class="m-r-5 font-18 mdi mdi-link-variant"></i>Create Clients Testimony</h6>
                            </div>
                        </div>

                        <form action="{{url('admin/clients-testimony/submit')}}" enctype="multipart/form-data" method="post"
                              id="addNewTestimonyForm">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label class="col-md-12">Name <span class="req">*</span></label>
                                <div class="col-md-12">
                                    <input type="text" name="name" placeholder="Name of client" value=""
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="company" placeholder="Company of client" value=""
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="pwd">Description <span class="req">*</span></label>
                                <div class="col-sm-12">
