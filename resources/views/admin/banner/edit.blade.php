            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-5">
                                <h6 class="card-title m-t-40"><i class="m-r-5 font-18 mdi mdi-animation"></i>Edit
                                    Homepage
                                    Banner
                                </h6>
                            </div>
                        ...
                        <form action="{{url('admin/banner/'.$data->id.'/update')}}" enctype="multipart/form-data" method="post"
                              id="addNewBannerForm">
                            {{csrf_field()}}
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="text" placeholder="Text to show on banner"
                                           onfocus="removeError('banner-text')" value="{{old('text', $data->text)}}"
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{asset('public/images/banners/'.$data->image)}}" alt="banner-image" style="width: 200px; height: 150px;">
                            </div>
