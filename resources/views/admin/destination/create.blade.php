                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="create-form" class="form-horizontal blog-form" method="post"
                              action="{{url('admin/destinations/submit')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{old('trip_destination')}}" class="form-control"
                                           id="trip_destination"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{old('total_duration')}}" class="form-control"
                                           id="total_duration"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{old('primary_activities')}}" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{old('group_size')}}" class="form-control"
                                           id="group_size"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{old('transportation')}}" class="form-control"
                                           id="transportation"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="top" class="form-control form-control-line">
                                        <option value="no" {{old('top') == 'no' ? 'selected' : ''}}>No
                                        </option>
                                        <option value="yes" {{old('top') == 'yes' ? 'selected' : ''}}>
                                            Yes
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="summary" id="summary"
                                              onfocus="removeError();">{{old('summary')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="review" id="review"
                                              onfocus="removeError();">{{old('review')}}</textarea>
