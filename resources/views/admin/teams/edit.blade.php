            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-5">
                                <h6 class="card-title m-t-40"><i class="m-r-5 font-18 mdi mdi-account-multiple"></i>Edit Team
                                    Member</h6>
                            </div>
                        </div>

                        <form action="{{url('admin/our-team/'.$team->id.'/update')}}" enctype="multipart/form-data"
                              method="post"
                              id="addNewMemberForm">
                            {{csrf_field()}}
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="name" placeholder="Name of a member"
                                           onfocus="removeError('name')" value="{{old('name', $team->name)}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <img src="{{asset('public/images/teams/small/'.$team->image)}}" alt="team"
                                         id="existing-image">
                                </div>
                            </div>
