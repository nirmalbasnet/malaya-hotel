            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-5">
                                <h6 class="card-title m-t-40"><i class="m-r-5 font-18 mdi mdi-account-convert"></i>Edit Guide</h6>
                            </div>
                        </div>

                        <form action="{{url('admin/guides/'.$guide->id.'/update')}}" enctype="multipart/form-data" method="post"
                              id="addNewGuideForm">
                            {{csrf_field()}}
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="name" placeholder="Name of a guide"
                                           onfocus="removeError('name')" value="{{old('name', $guide->name)}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select name="category" id="category" class="form-control category" onfocus="removeError('category');">
                                        <option value="Travel Guide" {{$guide->category == 'Travel Guide' ? 'selected' : ''}}>Travel Guide</option>
                                    </select>
                            ...
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Existing Image</label>
                                <div class="col-md-12">
                                    <img src="{{asset('public/images/guides/small/'.$guide->image)}}" alt="">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Image (Greater Than Or Equal To 400
                                    x 400 | Max 2 MB | PNG,JPG,JPEG,GIF)</label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="fb_link" placeholder="Facebook link of a guide"
                                           onfocus="removeError('fblink')" value="{{old('fb_link', $guide->fb_link != 'N/A' ? $guide->fb_link : '')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="skype_link" placeholder="Skype link of a guide"
                                           onfocus="removeError('skypelink')" value="{{old('skype_link', $guide->skype_link != 'N/A' ? $guide->skype_link : '')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="insta_link" placeholder="Instagram link of a guide"
                                           onfocus="removeError('instalink')" value="{{old('insta_link', $guide->insta_link != 'N/A' ? $guide->insta_link : '')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="linkedin_link" placeholder="Linkedin link of a guide"
                                           onfocus="removeError('linkedinlink')" value="{{old('linkedin_link', $guide->linkedin_link != 'N/A' ? $guide->linkedin_link : '')}}"
