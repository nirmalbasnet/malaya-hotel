            ...
            <div class="row">
                <div class="col-md-8">
                    @if(\Illuminate\Support\Facades\Session::has('review-redirect-message'))
                        @if(\Illuminate\Support\Facades\Session::get('review-redirect-message') == 'review')
                            <p class="review-thanks">Thank you for your review. It will get approved soon.</p>
                        @else
                            <p class="review-thanks">Thank you for your review. It will get approved soon. Also please
                                visit your mail to activate your account.</p>
                        @endif
                    @endif
                    <main>
                                    ...
                                    <div id="review"
                                        ...
                                        <div class="summary-content">
                                            ...
                                            <form method="post" id="review-form"
                                                  action="{{url('top-destination/'.$destination->slug.'/submit-review')}}">
                                                {{csrf_field()}}
                                                <div class="contact-title">
                                                    <h3>Leave Review</h3>
                                                </div>
                ...
                <div class="col-md-4">
                    <div id="secondary" class="sidebar">
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="booking-form">
                                <span class="thank-you-message"
                                      style="display: none; color: #267c5b; font-weight: 600;">Thank You. We&apos;ll get back to you soon.</span>
                                <form id="book-form" method="post">
                                    <div class="form-group">
                                        <input value="{{\Illuminate\Support\Facades\Auth::check() ? \Illuminate\Support\Facades\Auth::user()->name : ''}}"
                                               type="text" name="booker_name" id="booker-name" placeholder="Your name"
                                               autocomplete="off">
                                        <span class="error"></span>
                                    </div>
                                    <div class="form-group">
                                        <input value="{{\Illuminate\Support\Facades\Auth::check() ? \Illuminate\Support\Facades\Auth::user()->email : ''}}"
                                               type="text" name="booker_email" id="booker-email"
                                    ...
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn allstar-btn" id="book-form-submit">Book Now
                                        </button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="booking-form">
                                <span class="inquiry-thank-you-message"
                                      style="display: none; color: #267c5b; font-weight: 600;">Thank You. We&apos;ll get back to you soon.</span>
                                <form id="inquiry-form">
                                    ...
                                    {{--</div>--}}
                                    <div class="form-group">
                                        <textarea class="form-control" placeholder="Inquiry*" name="inquiry"
                                                  id="inquiry" rows="5"></textarea>
                                        <span class="error"></span>
                                    </div>
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn allstar-btn" id="inquiry-form-submit">Submit
                                        </button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="sidebar-content">
                                    <ul>
                                        @foreach($randomDestination as $randDest)
                                            <li>
                                                <a href="{{url('top-destination/'.$randDest->slug)}}">{{$randDest->title}}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
    ...
    <script>
        ...
        $('#book-form').on('submit', function (e) {
            ...
            if (error === 0) {
                ...
                $.ajax({
                    url: baseurl + '/top-destination/' + "{{$destination->id}}" + '/book?' + formData,
                    type: 'get',
